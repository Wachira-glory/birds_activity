...
class FifthBirdActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnBack5.setOnClickListener { finish() }
        Picasso.get()
            .load("https://images.unsplash.com/photo-1591055749071-927e6ddffc82?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
